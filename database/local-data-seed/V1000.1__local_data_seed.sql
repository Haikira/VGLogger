...
insert into games (name, description, developer_id) values ('Elden Ring', 'In the Lands Between ruled by Queen Marika the Eternal, the Elden Ring, the source of the Erdtree, has been shattered.' , (select id from developers where name ='FromSoftware'));
...
insert into users (first_name, last_name, email, password) values ('Campbell', 'Gilpin', 'campbell.gilpin@unosquare.com', '$2a$11$mcQe43JwQRTGX5razhuIhuBj17uQ1u3YIYgqJsQebQwpHgiNoot1u');
...
insert into game_dates (date, date_type_id, user_game_id) values ('2022-12-11', (select id from date_types where type_of_date ='Purchase Date'), (select id from users_games where user_id = (select id from users where first_name ='Campbell') AND game_platform_id = (select id from games_platforms where game_id = (select id from games where name ='God of War Ragnarok') AND platform_id = (select id from platforms where name ='Playstation 5'))));
insert into game_dates (date, date_type_id, user_game_id) values ('2023-01-02', (select id from date_types where type_of_date ='Completed Date'), (select id from users_games where user_id = (select id from users where first_name ='Campbell') AND game_platform_id = (select id from games_platforms where game_id = (select id from games where name ='God of War Ragnarok') AND platform_id = (select id from platforms where name ='Playstation 5'))));
